...
?>
  ...
  <section class = "background" id="background">
      <div class="content">
          <h3> Elevate your home with premium construction materials </h3>
          <p>From foundation to finishing, embrace the quality and durability you deserve</p>   
      </div>
  </section>
  ...
  <section class = "features" id ="features">
      ...
      <div class="furniture-container">
          <div class="box">
          <a href=""><img src="Image-2/Cement.jpeg" ></a>  
            <p> <a href="\GHAR_1\product_fetch\Cement_fetch.php">Cement</a><p>
          </div>

          <div class="box">
            <a href="\GHAR_1\product_fetch\bricks_fetch.php" ><img src="Image-2/Brick.jpg" ></a> 
              <p>Bricks<p>
            </div>

            <div class="box">
            <a href="" > <img src="Image-2/Rods.png" ></a> 
              <p>Rods</p>
            </div>
      </div> 
      <div class="furniture-container">
        <div class="box">
        <a href=""><img src="Image-2/sand.jpg" ></a>  
          <p>Sand<p>
        </div>

        <div class="box">
          <a href="" ><img src="Image-2/Aggregates.webp" ></a> 
            <p>Aggregates<p>
          </div>

          <div class="box">
          <a href="" > <img src="Image-2/RoofMaterials.png" ></a> 
            <p> Roof Materials</p>
          </div>
    </div> 
  </section> 
  <!-- </div> -->
  <!-- For kitchen and dining furniture -->
  <div class="blank"></div>
  <section> 
    <div class="heading">
    ...
    <div class="furniture-container">
        <div class="box">
        <a href=""><img src="Image-2/Wiring.jpg" ></a>  
          <p>Wiring</p>
        </div>

        <div class="box">
            <img src="Image-2/Switches.jpg" >
            <p>Switches</p>
          </div>

          <div class="box">
            <img src="Image-2/Lighting fixtures.jpg" >
  ...
  <section> 
    <div class="heading">
      <p>Hardware and Sanitary Products</p>
    </div>   
    <div class="furniture-container">
        <div class="box">
          <img src="Image-2/Pipes.png" >
          <p>Pipes</p>
        </div>

        <div class="box">
            <img src="Image-2/Faucets.jpg" >
            <p>Faucets</p>
          </div>

          <div class="box">
            <img src="Image-2/Sanitary fittings.png" >
  ...
  <section> 
    ...
    <div class="furniture-container">
        <div class="box">
          <img src="Image-2/Tiles.jpg" >
          <p>Tiles</p>
        </div>

        <div class="box">
            <img src="Image-2/Marble.jpg" >
            <p>Marble</p>
          </div>

          <div class="box">
            <img src="Image-2/Paints.png" >
            <p>Paints</p>      
    </div>
    </div>
  </section>
  ...
  <section> 
    ...
    <div class="furniture-container">
        <div class="box">
        <a href="/GHAR_1/product_fetch/Table_fetch.php">  <img src="Image-2/DiningTable.png" ></a>
          <p>Dining Table</p>
        </div>

        <div class="box">
          <a href="/GHAR_1/product_fetch/Chair_fetch.php"> <img src="Image-2/LivingRoomChair.png" ></a>
            <p>Chair</p>
          </div>

          <div class="box">
          <a href="/GHAR_1/product_fetch/Sofa_fetch.php"> <img src="Image-2/sofa.jpg" ></a>
            <p>Sofa</p>      
    </div>
    </div>
  </section>
