        ...
        <div class="main">
          <div class="container">
            ...
            <aside class="pro-section-container">
              <div>
                <header class="pro-head">Welcome to Ghar</header>
          ...
          <section class="section">
            <div class="shop-card">
              ...
              <div class="card-body">
                ...
                <div class="furniture-container">
                  <div class="card-furniture">
                    <a href="/GHAR_1/product_fetch/Table_fetch.php">
                      <div class="product-img">
                        <picture
                          ><img
          ...
          <section class="section">
            <div class="shop-card">
              ...
              <div class="card-body">
                ...
                <div class="furniture-container">
                  <div class="card-furniture">
                    <a href="/GHAR_1/product_fetch/bricks_fetch.php">
                      <div class="product-img">
                        <picture
                          ><img
                ...
                <div class="furniture-container">
                  <div class="card-furniture">
                    <a href="/GHAR_1/product_fetch/Cement_fetch.php">
                      <div class="product-img">
                        <picture
                          ><img
