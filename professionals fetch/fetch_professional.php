...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="professionals_fetchstyles.css">
  ...
  <body>
      ...
      <main>
          ...
          <div class="project-list">
            <div class="project-container">
              <div class="project-header">
                <h2>Which of the following best matches your project?</h2>
              </div>
              ...
              <div class="products">
                <div class="product-card">
                  ...
                  <img
                    src="/GHAR_1/gharimg/bathroomremodeling.jpg"
                ...
                <div class="product-card">
                  ...
                  <img
                    src="/GHAR_1/gharimg/kitchenremodeling.jpg"
                ...
                <div class="product-card">
                  ...
                  <img
                    src="/GHAR_1/gharimg/customhome.jpg"
                    alt="Custom Home"
                    class="product-image"
                  />
                  <div class="product-info">
                ...
                <div class="product-card">
                  ...
                  <img
                    src="/GHAR_1/gharimg/newhomeconstruction.jpg"
        ...
        <section>
          <div class="pro-container">
            <div>
              <h1 class="find-text">Find Professionals</h1>
              <span class="find-extra">Don't know how to begin?</span>
            </div>
            <div class="search-body">
              <div>
                <div class="search-text">Search Local Professionals</div>
                <div class="search-subtitle">We'll put you in touch with pros who can help</div>
              </div>
              <div class="Serach-button">
                <div>
                  <input class="search-Pros" type="text" placeholder="Search Pros" />
                </div>
                <div>
                  <button class="getstarted-btn" type="button">Get Started</button>
                </div>
              </div>  
            </div>
          </div>
        ...
        <section>
          <div class="container">
            <h1 class="title">
              Kathmandu, Central Region, Nepal Home Improvement Pros
            </h1>
          </div>
        </section>  
    ...
    <?php
    $stmt = $conn->prepare("SELECT prid, prof_name, prof_image, prof_role, operating_area FROM professionals");
    $stmt->execute();
    ...
    while ($row = $result->fetch_assoc()) {    
      ...
      echo  '<div class="grid">
          <a href="/WEB/GHAR/proprofile.html" >';
      echo '<div class="card">';
      echo '<div class="card-header">';
      echo  '<div class="avatar">';
      echo '<img src="' . htmlspecialchars($image_path) . '" alt="Professional Image">';
      echo '</div>';
      echo '<div>';
      echo '<h2 class="card-title"> ' . htmlspecialchars($row['prof_name']) .' </h2>';
      echo '</div>';
      echo '</div>';
      echo '<div class="card-content">';
      echo '<p>' . htmlspecialchars($row['prof_role']) . '</p>';
      //echo '<a  class="read-text"href="profile_fetch.php".htmlspecialchars($row['prid'])>Read more ></a>';
      echo '<a class="read-text" href="profile_fetch.php?id=' . htmlspecialchars($row['prid']) . '">Read more ></a>';
      echo '</div>';
      echo '<div class="card-footer">';
      echo '<div class="location">';
      echo  '<span>'. htmlspecialchars($row['operating_area']) .'</span>';
      echo '</div>';
      echo '</div>';
      echo '</div>';
      echo '</div>';
